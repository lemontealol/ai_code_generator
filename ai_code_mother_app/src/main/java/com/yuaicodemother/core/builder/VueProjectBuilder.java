package com.yuaicodemother.core.builder;
...
public class VueProjectBuilder {
        ...
        Thread.ofVirtual().name("vue-builder-" + System.currentTimeMillis())
                .start(()->{
                    try {
                        ...
                        log.error("构建 Vue 项目时发生错误：{}" , e.getMessage(),e);
                    }
                });
    }
    ...
    public boolean buildProject(String projectPath) {
        ...
        if (!packageJsonFile.exists()){
            log.error("项目目录不存在package.json文件：{}",projectPath);
            return false;
        }
     ...
     * 判断当前操作系统是否为 Windows
     *
     * @return true 为 Windows，false 为其他操作系统
     */
