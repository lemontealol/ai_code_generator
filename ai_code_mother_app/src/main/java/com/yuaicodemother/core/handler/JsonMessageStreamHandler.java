package com.yuaicodemother.core.handler;
...
import com.yuaicodemother.ai.tools.BaseTool;
...
//                    String projectRootPath = Path.of(AppConstant.CODE_OUTPUT_ROOT_DIR, "vue_project_" + appId).toString();
//                    vueProjectBuilder.buildProjectAsync(projectRootPath);
                })
                .doOnError(error -> {
                    // 如果AI回复失败，也要记录错误消息
